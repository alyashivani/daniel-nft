module BxBlockProfile
  class Profile < BxBlockProfile::ApplicationRecord
    ...
    has_one :image, as: :attached_item, class_name: "Image", dependent: :destroy
    after_create :set_account_status
    ...
    # enum profile_role: [:admin, :customer]
    ...
    def set_account_status
      self.account.update(account_status: "profile_created")
    end
  end
end
