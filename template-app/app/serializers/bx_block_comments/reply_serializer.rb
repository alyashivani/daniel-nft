module BxBlockComments
  class ReplySerializer < BuilderBase::BaseSerializer
    ...
    attribute :replies do |object, params|
      ...
      if object.replies.present?
        ...
        reply = ReplySerializer.new(replies, params: {current_user: params[:current_user], filter_param: params[:filter_param]})
      end
      reply
    end
  end
